...
/*
searches for a BusRide in the array v (actually is a vecotr of pointers), that has the same "from" field as the string from. if there are multiple BusRides with the same "from" field, the function returns all of them, in an array of integers. at each new match, the function will realloc the array to fit the new element. -1 is put at the end to signal the end of the list
*/
